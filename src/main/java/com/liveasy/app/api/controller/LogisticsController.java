...
/**
 * <ul>
 * <li> This is the main Rest Controller which will have the url as http:localhost:8081/load as the preliminary url</li>
 * <li> Implemented four types of call : post, get, put, delete </li>
 * </ul>
 */
@CrossOrigin(origins = "*")
@RestController
